...
import { PenTool, Code2, BookOpen, Layers, Settings, Moon, Sun, User, Workflow, Terminal } from 'lucide-react';
...
export default function Navbar() {
    ...
    const links = [
        ...
        { path: '/cli', label: 'CLI Tool', icon: <Terminal className="w-3.5 h-3.5" /> },
