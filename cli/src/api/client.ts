...
const FOLDER_PURPOSES: Record<string, string> = {
  ...
  bin: 'Executable CLI entrypoints and binary wrappers.',
  components: 'Reusable UI components, layout wrappers, and atomic controls.',
  routes: 'API endpoints, HTTP request controllers, and route handlers.',
  services: 'Business logic, external API integrations, and data processing.',
  utils: 'Helper functions, formatters, and shared utility abstractions.',
  types: 'TypeScript interfaces, type guards, and shared contracts.',
  pages: 'Page views, screen layouts, and route-level components.',
  store: 'Global state management stores and context providers.',
  ...
  docs: 'Project documentation, guides, and architecture docs.',
  tests: 'Automated unit, integration, and end-to-end test suites.',
  test: 'Automated unit, integration, and end-to-end test suites.',
  '__tests__': 'Jest test suites and fixtures.',
  config: 'Environment configuration and application settings.',
  frontend: 'Frontend client application — UI, pages, and components.',
  backend: 'Backend server — API routes, services, and business logic.',
  server: 'Backend server entry and configuration.',
  client: 'Frontend client application bundle.',
  cli: 'Command-line interface tool and terminal commands.',
  api: 'API route handlers, controllers, and endpoint definitions.',
  lib: 'Shared library code and internal packages.',
  packages: 'Monorepo workspace packages.',
  app: 'Main application entry and core module.',
  web: 'Web application frontend.',
  scripts: 'Build scripts, automation, and developer tooling.',
  assets: 'Static assets — images, fonts, and media files.',
  hooks: 'Custom React hooks and lifecycle abstractions.',
  middleware: 'Express/HTTP middleware functions.',
  controllers: 'Request controllers and handler logic.',
  migrations: 'Database migration scripts and version history.',
  seeds: 'Database seed data for development and testing.',
  fixtures: 'Test fixtures and mock data.',
  '.github': 'GitHub configuration — Actions workflows, issue templates.',
